...
const Input: FC<InputProps> = ({ type = "text", className = "", disabled = false, success = false, error = false, hint, ...props }) => {
    ...
    return (
        <div className="relative">
            <input type={type} disabled={disabled} className={inputClasses} {...props} />
